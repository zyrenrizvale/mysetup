import type { ArrayLike, Class, EvenInteger, Falsy, FiniteNumber, Integer, NaN as NaNType, NegativeInfinity, NegativeInteger, NegativeNumber, NodeStream, NonEmptyString, NonNegativeInteger, NonNegativeNumber, ObservableLike, OddInteger, Predicate, Primitive, PositiveInfinity, PositiveInteger, PositiveNumber, SafeInteger, TypedArray, UrlString, ValidLength, WeakRef, Whitespace } from './types.ts';
...
type NumericGuardResult<Input, Branded extends number> = (unknown extends Input ? Branded : Input extends number ? Branded & Input : number) & Input;
...
export declare function isAll<T1>(predicates: [TypeGuard<T1>]): TypeGuard<T1>;
export declare function isAll<T1, T2>(predicates: [TypeGuard<T1>, TypeGuard<T2>]): TypeGuard<T1 & T2>;
export declare function isAll<T1, T2, T3>(predicates: [TypeGuard<T1>, TypeGuard<T2>, TypeGuard<T3>]): TypeGuard<T1 & T2 & T3>;
export declare function isAll<T1, T2, T3, T4>(predicates: [TypeGuard<T1>, TypeGuard<T2>, TypeGuard<T3>, TypeGuard<T4>]): TypeGuard<T1 & T2 & T3 & T4>;
export declare function isAll<T1, T2, T3, T4, T5>(predicates: [TypeGuard<T1>, TypeGuard<T2>, TypeGuard<T3>, TypeGuard<T4>, TypeGuard<T5>]): TypeGuard<T1 & T2 & T3 & T4 & T5>;
export declare function isAll(predicates: ReadonlyArray<TypeGuard<unknown>>): TypeGuard<unknown>;
export declare function isAll(predicates: readonly Predicate[]): Predicate;
export declare function isAll(predicate: Predicate | readonly Predicate[], ...values: unknown[]): boolean;
export declare function isAny<T1>(predicates: [TypeGuard<T1>]): TypeGuard<T1>;
export declare function isAny<T1, T2>(predicates: [TypeGuard<T1>, TypeGuard<T2>]): TypeGuard<T1 | T2>;
export declare function isAny<T1, T2, T3>(predicates: [TypeGuard<T1>, TypeGuard<T2>, TypeGuard<T3>]): TypeGuard<T1 | T2 | T3>;
export declare function isAny<T1, T2, T3, T4>(predicates: [TypeGuard<T1>, TypeGuard<T2>, TypeGuard<T3>, TypeGuard<T4>]): TypeGuard<T1 | T2 | T3 | T4>;
export declare function isAny<T1, T2, T3, T4, T5>(predicates: [TypeGuard<T1>, TypeGuard<T2>, TypeGuard<T3>, TypeGuard<T4>, TypeGuard<T5>]): TypeGuard<T1 | T2 | T3 | T4 | T5>;
export declare function isAny(predicates: ReadonlyArray<TypeGuard<unknown>>): TypeGuard<unknown>;
export declare function isAny(predicates: readonly Predicate[]): Predicate;
export declare function isAny(predicate: Predicate | readonly Predicate[], ...values: unknown[]): boolean;
export declare function isOptional<T>(value: unknown, predicate: (value: unknown) => value is T): value is T | undefined;
...
export declare function isArrayOf<T>(predicate: (value: unknown) => value is T): (value: unknown) => value is T[];
...
export declare function isEvenInteger<Input>(value: Input): value is NumericGuardResult<Input, EvenInteger>;
export declare function isFalsy(value: unknown): value is Falsy;
export declare function isFiniteNumber<Input>(value: Input): value is NumericGuardResult<Input, FiniteNumber>;
...
export declare function isInfinite<Input>(value: Input): value is NumericGuardResult<Input, PositiveInfinity | NegativeInfinity>;
...
export declare function isInteger<Input>(value: Input): value is NumericGuardResult<Input, Integer>;
...
export declare function isNan<Input>(value: Input): value is NumericGuardResult<Input, NaNType>;
export declare function isNativePromise<T = unknown>(value: unknown): value is Promise<T>;
export declare function isNegativeInteger<Input>(value: Input): value is NumericGuardResult<Input, NegativeInteger>;
export declare function isNegativeNumber<Input>(value: Input): value is NumericGuardResult<Input, NegativeNumber>;
...
export declare function isNonNegativeInteger<Input>(value: Input): value is NumericGuardResult<Input, NonNegativeInteger>;
export declare function isNonNegativeNumber<Input>(value: Input): value is NumericGuardResult<Input, NonNegativeNumber>;
...
export declare function isOddInteger<Input>(value: Input): value is NumericGuardResult<Input, OddInteger>;
export declare function isOneOf<T extends readonly unknown[]>(values: T): (value: unknown) => value is T[number];
export declare function isPlainObject<Value = unknown>(value: unknown): value is Record<PropertyKey, Value>;
export declare function isPositiveInteger<Input>(value: Input): value is NumericGuardResult<Input, PositiveInteger>;
export declare function isPositiveNumber<Input>(value: Input): value is NumericGuardResult<Input, PositiveNumber>;
...
export declare function isSafeInteger<Input>(value: Input): value is NumericGuardResult<Input, SafeInteger>;
...
export declare function isValidLength<Input>(value: Input): value is NumericGuardResult<Input, ValidLength>;
...
export declare const assertNotUndefined: NotAssertion<undefined, UnknownNotPrimitive<undefined>>;
export declare const assertNotNull: NotAssertion<null, UnknownNotPrimitive<null>>;
export declare const assertNotNullOrUndefined: NotAssertion<null | undefined, UnknownNotPrimitive<null | undefined>>;
export declare const assertNotString: NotAssertion<string, UnknownNotPrimitive<string>>;
export declare const assertNotBoolean: NotAssertion<boolean, UnknownNotPrimitive<boolean>>;
export declare const assertNotSymbol: NotAssertion<symbol, UnknownNotPrimitive<symbol>>;
export declare const assertNotBigint: NotAssertion<bigint, UnknownNotPrimitive<bigint>>;
export declare const assertNotPrimitive: NotAssertion<Primitive, object>;
export declare const assert: Assert;
export declare function assertAll(predicate: Predicate | readonly Predicate[], ...values: unknown[]): void | never;
export declare function assertAny(predicate: Predicate | readonly Predicate[], ...values: unknown[]): void | never;
export declare function assertOptional<T>(value: unknown, assertion: (value: unknown, message?: string) => asserts value is T, message?: string): asserts value is T | undefined;
...
export declare function assertFiniteNumber(value: unknown, message?: string): asserts value is number;
...
export declare function assertNegativeInteger(value: unknown, message?: string): asserts value is number;
...
export declare function assertNonNegativeInteger(value: unknown, message?: string): asserts value is number;
export declare function assertNonNegativeNumber(value: unknown, message?: string): asserts value is number;
...
export declare function assertPositiveInteger(value: unknown, message?: string): asserts value is number;
...
export declare function assertPropertyKey(value: unknown, message?: string): asserts value is PropertyKey;
...
export declare function assertUrlString(value: unknown, message?: string): asserts value is UrlString;
...
export default is;
export type { ArrayLike, Class, EvenInteger, FiniteNumber, Integer, NaN, NegativeInfinity, NegativeInteger, NegativeNumber, NodeStream, NonNegativeInteger, NonNegativeNumber, ObservableLike, OddInteger, PositiveInfinity, PositiveInteger, PositiveNumber, Predicate, Primitive, SafeInteger, TypedArray, UrlString, ValidLength, } from './types.ts';
